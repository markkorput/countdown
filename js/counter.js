...
(function() {
  var CountCollection, _ref, _ref1,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  CountCollection = (function(_super) {
    __extends(CountCollection, _super);

    function CountCollection() {
      _ref = CountCollection.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    CountCollection.prototype.model = Count;
  ...
  this.Counter = (function(_super) {
    ...
    function Counter() {
      _ref1 = Counter.__super__.constructor.apply(this, arguments);
      return _ref1;
    }
    ...
    Counter.prototype.initialize = function() {
      ...
      this.count_ops = new CountCollection(count_ops_array);
      this.on('change:progress', function(model, value, obj) {
        model.set({
          idx: this.calcIndex()
        });
        return model.currentOp().spinscale((value - model.countLength() * model.get('idx')) / model.countLength());
      });
